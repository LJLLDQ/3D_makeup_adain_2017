...
# from solver_makeup_stargan2 import Solver_makeupGAN
from solver_makeup_stargan2 import Solver_makeupGAN
# from solver_makeup_new_adain import Solver_makeupGAN


def parse_args():
    parser = argparse.ArgumentParser(description='Train GAN')
    # general
    # parser.add_argument('--data_path', default='/home/jinliang/Final_362/', type=str, help='training and test data path')
    parser.add_argument('--data_path', default='/home/jl/LJL_new_data_part_362/', type=str, help='training and test data path')    
    ...
    parser.add_argument('--eye', type=bool, default=False, help='whether to finetune eye shadow color')
